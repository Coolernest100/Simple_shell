...
/**
 * add_node - include a node to the origin of the list
...
/**
 * add_node_end - include a node to the extreme of the list
 * @head: the address of pointer to head node
 * @str: str field of node
...
/**
 * delete_node_at_index - remove the node at given index
...
/**
 * free_list - allows all nodes of a list
