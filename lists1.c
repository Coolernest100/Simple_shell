...
/**
 * list_len - decide the length of linked list
...
/**
 * list_to_strings - take back array of strings of the list->str
...
/**
 * node_starts_with - take back node whose string begins with prefix
...
/**
 * get_node_index - collects the index of a node
